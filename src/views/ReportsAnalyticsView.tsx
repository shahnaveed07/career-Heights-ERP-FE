    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-500">
            Consolidated operational, revenue, admission funnel and academic performance matrices.
          </p>
        </div>
          ...
          <table className="min-w-full divide-y divide-slate-200 text-xs">
            <thead className="bg-slate-50 text-slate-700 font-bold uppercase text-[10px]">
              <tr>
                ...
                <th className="py-3 px-4 text-center">Biometric Attendance %</th>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
          <h3 className="text-sm font-bold text-slate-900">Admissions Pipeline Conversion Funnel</h3>
          <div className="space-y-3 text-xs">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
              <div className="flex justify-between items-center mb-1">
                <span className="font-semibold text-slate-700">1. Fresh Walk-Ins &amp; Inquiries</span>
                <span className="font-bold text-slate-900">{totalEnquiries} Leads (100%)</span>
              </div>
            ...
            <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200">
              <div className="flex justify-between items-center mb-1">
                <span className="font-bold text-emerald-950">4. Formally Enrolled &amp; Fee Paid</span>
                <span className="font-black text-emerald-900">{enrolledEnquiries} Admissions ({overallConversion}%)</span>
              </div>
              <div className="h-2 w-full bg-emerald-200 rounded-full overflow-hidden">
                <div className="h-full bg-emerald-600" style={{ width: `${overallConversion}%` }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-4">
          <h3 className="text-sm font-bold text-slate-900">Career Heights Competitive Benchmarks</h3>
          <div className="space-y-3 text-xs">
            <div className="rounded-xl border border-slate-200 p-3.5 space-y-1">
              <div className="flex justify-between">
                <span className="font-semibold text-slate-600">NEET Top Score (Mock Phase 1):</span>
                <strong className="text-slate-900">682 / 720</strong>
              </div>
              <p className="text-[11px] text-slate-400">Scored by Pre-Medical Handwara batch candidate</p>
            </div>

            <div className="rounded-xl border border-slate-200 p-3.5 space-y-1">
              <div className="flex justify-between">
                <span className="font-semibold text-slate-600">JEE Advanced Top Score:</span>
                <strong className="text-slate-900">338 / 360</strong>
              </div>
              <p className="text-[11px] text-slate-400">Aarav Sharma (CH-2026-001)</p>
            </div>

            <div className="rounded-xl border border-slate-200 p-3.5 space-y-1">
              <div className="flex justify-between">
                <span className="font-semibold text-slate-600">CHTQ Registered Candidates:</span>
                <strong className="text-amber-800">
                  {chtqSchools.reduce((acc, s) => acc + s.registeredCount, 0)} Deserving Candidates
                </strong>
              </div>
              <p className="text-[11px] text-slate-400">100%, 75%, and 50% tuition subsidies awarded</p>
            </div>
          </div>
        </div>
      </div>
