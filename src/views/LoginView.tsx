  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center py-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-200">
            <div>
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-bold text-slate-900">Sign in to ERP Console</h2>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-medium text-slate-400">Demo: Demo@123</span>
                  </div>
                  <div className="relative mt-1">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Select any persona to instantly test their tailored dashboard and permissions.
                </p>
              </div>
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className={`rounded px-1.5 py-0.5 text-[10px] font-bold ${acc.badgeColor}`}>
                        {acc.label}
                      </span>
                      {acc.branch && (
      ...
      <div className="mt-6 text-center text-xs text-slate-500">
        <p>Enterprise Hierarchy: HQ &rarr; Branch (5) &rarr; Wing &rarr; Class &rarr; Batch &rarr; Student</p>
        <p className="text-[11px] text-slate-400 mt-1">
          Demo data seeded for review • All rights reserved &copy; 2026 Career Heights Education
        </p>
      </div>
    </div>
  );
