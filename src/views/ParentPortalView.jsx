    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-blue-200">
                ...
                • {child.branchName} • {child.batchName}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() =>
                alert(
                  `Connecting call with Handwara Batch Mentor / Academic Counselor...`
                )
              }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Total days present: 82 / 88 (Excellent discipline)
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs space-y-4">
          <div className="flex items-center justify-between border-b pb-3">
            <h3 className="text-sm font-bold text-slate-900">
              Official Computerized Receipts Issued
            </h3>
          ...
          <div className="rounded-xl bg-blue-50 border border-blue-200 p-4 text-xs text-blue-950 space-y-1">
            <strong className="block font-bold">
              Career Heights Transparent Parent Guarantee:
            </strong>
            <p className="text-[11px] text-blue-800 leading-relaxed">
              Parents receive real-time SMS alerts at 08:35 AM upon biometric
              check-in and instantaneous SMS report cards when OMR sheets are
              scanned.
            </p>
          </div>
        </div>
